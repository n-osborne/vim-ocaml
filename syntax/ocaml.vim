...
" Comments
syn region   ocamlComment keepend start="(\*" end="\*)" contains=@Spell,ocamlComment,ocamlTodo,ocamlGospel
...
hi def link ocamlGospel Include
hi def link ocamlGospelKw Keyword
hi def link ocamlGospelConst Constant
hi def link ocamlGospelQuantifier Special
hi def link ocamlGospelDoubleArrow ocamlArrow
hi def link ocamlGospelType ocamlTypeBuiltin
